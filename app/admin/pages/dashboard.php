...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="alert alert-secondary" style="color: #383d41; background-color: #e2e3e5; border-color: #d6d8db;">
            Selamat Datang, <?= $_SESSION['fullname']; ?> di Administrator GaleriBaca.
        </div>
        ...
        <div class="row">
            ...
            <img src="../../assets/dist/img/logo.png" width="120px" height="120px" style="display: block; margin-left: auto; margin-right: auto; margin-top: 150px; margin-bottom: -40px;">

...
if ($_GET['act'] == "tambah") {
    ...
    $query = "INSERT INTO user(kode_user,nis,fullname,username,password,prodi,alamat,verif,role,join_date)
        VALUES('" . $kode_user . "','" . $nis . "','" . $fullname . "','" . $username . "','" . $password . "','" . $prodi . "','" . $alamat . "', '" . $verif . "','" . $role . "','" . $join_date . "')";

...
if ($_GET['aksi'] == "tambah") {
    ...
    $sql = "INSERT INTO user(kode_user,nis,fullname,username,password,prodi,alamat,verif,role,join_date)
        VALUES('" . $kode_anggota . "','" . $nis . "','" . $fullname . "','" . $username . "','" . $password . "','" . $prodi . "','" . $alamat . "','" . $verif . "','" . $role . "','" . $join_date . "')";

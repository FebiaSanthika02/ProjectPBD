        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="box">
                    ...
                    <div class="box-body">
                        <!-- Animasi -->
                        <img src="../../assets/dist/img/avatar6.png" style="width: 125px; height: 125px; display: block; margin-left: auto; margin-right: auto; margin-top: -5px; margin-bottom: 15px;" loop autoplay></lottie-player>
                        <!-- -->
                        ...
                        <p style="font-weight: bold;">Prodi : <?= $row['prodi']; ?></p>

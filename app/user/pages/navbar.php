<header class="main-header">
    ...
    <a href="dashboard" class="logo" style="font-family: 'Quicksand', sans-serif">
        ...
        <span class="logo-lg"><b>GaleriBaca</span>
    </a>
            ...
            <ul class="nav navbar-nav">
                                ...
                                ?>
                                    <li>
                                        ...
                                        <a href="lihat-pesan?id_pesan=<?= $row_pesan1['id_pesan']; ?>">
                                            <div class="pull-left">
                                                <img src="../../assets/dist/img/avatar6.png" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                <?php
                                                include "../../config/koneksi.php";
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="../../assets/dist/img/avatar6.png" class="user-image" alt="User Image">
